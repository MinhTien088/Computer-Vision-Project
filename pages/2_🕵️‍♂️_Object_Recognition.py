...
st.set_page_config(page_title="Nhận dạng các đối tượng", page_icon="🕵️‍♂️")

st.header("Nhận dạng các đối tượng")

try:
    if st.session_state["LoadModel2"] == True:
        print("Đã load model rồi")
except:
    model_path = os.path.join(curr_dir, "data/2_Object_Recognition/yolov8n.onnx")
...
filename_classes = os.path.join(curr_dir, "data/2_Object_Recognition/object_detection_classes_yolo.txt")
mywidth = 640
myheight = 640
